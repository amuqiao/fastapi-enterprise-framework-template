...
graph TB
    ...
    style DI fill:#4ECDC4,stroke:#2D3436,stroke-width:3px,color:#2D3436,rx:8,ry:8
    style ScopeManager fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style Registry fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style Resolver fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style Injector fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style AppScope fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style RequestScope fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style SessionScope fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    ...
    style TestFramework fill:#54A0FF,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style DIMock fill:#54A0FF,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
```
...
graph TD
    subgraph 依赖注入核心组件
        DIContainer[DIContainer容器] --> ScopeManager[作用域管理器]
        DIContainer --> DependencyRegistry[依赖注册表]
        DIContainer --> DependencyResolver[依赖解析器]
        DIContainer --> AutoInjector[自动注入器]
        
        ScopeManager --> AppScope[应用级作用域]
        ScopeManager --> RequestScope[请求级作用域]
        ScopeManager --> CustomScope[自定义作用域]
        
        DependencyRegistry --> RegistryMap[注册映射表]
        
        DependencyResolver --> TypeResolver[类型解析器]
        DependencyResolver --> InstanceCreator[实例创建器]
        
        AutoInjector --> FieldInjector[字段注入器]
        AutoInjector --> MethodInjector[方法注入器]
    end
    
    subgraph 依赖使用示例
        UserController[用户控制器] --> UserService[用户服务]
        UserService --> UserRepository[用户仓储]
        UserRepository --> Database[数据库]
        
        UserController --> DIContainer[DIContainer]
        UserService --> DIContainer
        UserRepository --> DIContainer
    end
    
    style DIContainer fill:#FF6B6B,stroke:#2D3436,stroke-width:3px,color:white,rx:8,ry:8
    style ScopeManager fill:#4ECDC4,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style DependencyRegistry fill:#4ECDC4,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style DependencyResolver fill:#4ECDC4,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style AutoInjector fill:#4ECDC4,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style AppScope fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style RequestScope fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style CustomScope fill:#45B7D1,stroke:#2D3436,stroke-width:2px,color:white,rx:8,ry:8
    style RegistryMap fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style TypeResolver fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style InstanceCreator fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style FieldInjector fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
    style MethodInjector fill:#FECA57,stroke:#2D3436,stroke-width:2px,color:#2D3436,rx:8,ry:8
